...
$string['chart_pluginusedrelativelabel'] = 'Moodle sites crawled: {$a->number}';
...
$string['pageviewchart'] = 'View chart';
$string['pageviewtable'] = 'View table';
...
$string['table_pluginusedrelativelabel'] = 'Moodle sites crawled: ';
